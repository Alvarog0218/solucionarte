...
export default function Hero({ onOpenWhatsApp }) {
  return (
    <section className="py-12 md:py-20 lg:py-24 relative overflow-hidden bg-gradient-to-b from-[#faf9f7] via-[#faf9f7] to-[#f4f3f1]/40">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-gradient-to-tr from-[#e0f7fc]/30 to-[#bbf2fc]/20 blur-3xl rounded-full pointer-events-none -z-10"></div>
      ...
      <div className="max-w-[1280px] mx-auto px-5 md:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            {/* Tag / Badge */}
            <div className="inline-flex items-center gap-2 bg-[#e0f7fc] text-[#0097b2] px-4 py-1.5 rounded-full text-xs font-bold tracking-wide mb-6 border border-[#bfc9c1]/50 shadow-2xs">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-8">
              ...
              <a
                href="#filosofia"
                className="w-full sm:w-auto px-7 py-4 text-[#00768c] hover:text-[#0097b2] font-bold text-base flex items-center justify-center gap-2 transition-colors hover:underline decoration-2 underline-offset-8"
              >
            ...
            <div className="pt-6 border-t border-[#e2f4f7] flex flex-wrap items-center justify-center lg:justify-start gap-6 text-xs text-[#556158]">
