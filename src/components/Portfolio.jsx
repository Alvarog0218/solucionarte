  ...
  return (
    <section className="py-16 md:py-24 bg-[#faf9f7]" id="portafolio">
      <div className="max-w-[1280px] mx-auto px-5 md:px-8">
        ...
        {/* 4-Project Row (Strict Single Line) */}
        <div className="grid grid-cols-4 gap-4 w-full">
          {projects.map((project, index) => {
            ...
            return (
              <div 
                key={index} 
                className="bg-white rounded-2xl md:rounded-3xl border border-[#e2f4f7] hover:border-[#0097b2]/40 p-4 md:p-6 hover-lift shadow-xs hover:shadow-xl transition-all duration-300 flex flex-col justify-between w-full"
              >
                <div>
                  {/* Category and Icon */}
